We have 78 repos written in 12 languages
...
|------|-------|----------|-------|--------|-------------|
| [take-home](http://github.com/NoRedInk/take-home) | 303 | Elm | 16 | 9 | A take-home application written in Elm and only Elm |
| [rspec-retry](http://github.com/NoRedInk/rspec-retry) | 225 | Ruby | 62 | 15 | retry randomly failing rspec example |
| [elm-decode-pipeline](http://github.com/NoRedInk/elm-decode-pipeline) | 130 | Elm | 21 | 3 | A pipeline-friendly library for building decoders. |
| [elm-style-guide](http://github.com/NoRedInk/elm-style-guide) | 121 | None | 4 | 1 | NoRedInk style guide for our Elm code |
| [elm-blogger](http://github.com/NoRedInk/elm-blogger) | 92 | Elixir | 12 | 9 | A blogging platform written in Elm + Elixir |
| [elm-rails](http://github.com/NoRedInk/elm-rails) | 80 | Elm | 13 | 0 | Convenience functions for using Elm with Rails. |
| [elm-phoenix](http://github.com/NoRedInk/elm-phoenix) | 73 | Elm | 4 | 2 | Phoenix helpers for Elm |
| [elm-ops-tooling](http://github.com/NoRedInk/elm-ops-tooling) | 62 | Python | 5 | 6 | Tooling for Elm ops |
...
| [elm-init-scripts](http://github.com/NoRedInk/elm-init-scripts) | 15 | Python | 2 | 1 | None |
| [elm_sprockets](http://github.com/NoRedInk/elm_sprockets) | 14 | Ruby | 5 | 1 | Sprockets preprocessor for Elm |
...
| [elm-simple-fuzzy](http://github.com/NoRedInk/elm-simple-fuzzy) | 7 | Elm | 0 | 0 | http://package.elm-lang.org/packages/NoRedInk/elm-simple-fuzzy/latest |
| [elm-assets-loader](http://github.com/NoRedInk/elm-assets-loader) | 7 | JavaScript | 0 | 0 | webpack loader for webpackifying asset references in Elm code |
...
| [rocket-update](http://github.com/NoRedInk/rocket-update) | 5 | Elm | 0 | 0 | A simpler alternative to (!) |
...
| [npm-elm-rails](http://github.com/NoRedInk/npm-elm-rails) | 3 | Ruby | 2 | 1 | A Rails plugin for using Elm files with the asset pipeline. |
| [elm-test-runner](http://github.com/NoRedInk/elm-test-runner) | 3 | Python | 1 | 0 | None |
| [elm-task-extra](http://github.com/NoRedInk/elm-task-extra) | 2 | Elm | 6 | 1 | Additional functions for working with tasks |
...
| [drag-and-drop](http://github.com/NoRedInk/drag-and-drop) | 2 | Elm | 0 | 0 | None |
| [elm-rollbar](http://github.com/NoRedInk/elm-rollbar) | 2 | Elm | 0 | 0 | Rollbar helpers for Elm |
...
| [elm-random-extra](http://github.com/NoRedInk/elm-random-extra) | 1 | Elm | 5 | 1 | Extra functionality for the core Random library |
...
| [nri-elm-css](http://github.com/NoRedInk/nri-elm-css) | 1 | Elm | 0 | 0 | Colors, fonts, etc for NRI branding |
| [greenhouse-interview-analytics](http://github.com/NoRedInk/greenhouse-interview-analytics) | 1 | JavaScript | 0 | 0 | None |
| [elm-sweet-poll](http://github.com/NoRedInk/elm-sweet-poll) | 1 | Elm | 1 | 2 | None |
| [epc](http://github.com/NoRedInk/epc) | 1 | Haskell | 0 | 0 | None |
| [deploy-complexity](http://github.com/NoRedInk/deploy-complexity) | 1 | Ruby | 0 | 0 | Analyze the history and complexity of each deploy |
| [elm-asset-path](http://github.com/NoRedInk/elm-asset-path) | 1 | Elm | 0 | 0 | None |
| [localstorage](http://github.com/NoRedInk/localstorage) | 1 | Elm | 0 | 0 | Elm effect manager for local storage |
...
| [elm-css-template](http://github.com/NoRedInk/elm-css-template) | 0 | Elm | 0 | 0 | This is meant for designers and people who want to experiment with elm-css. |
